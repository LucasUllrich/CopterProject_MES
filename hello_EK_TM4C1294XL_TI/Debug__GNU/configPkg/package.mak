...
.dlls,m4fg .dlls: main.pm4fg

-include package/cfg/main_pm4fg.mak
-include package/cfg/main_pm4fg.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/main_pm4fg.dep
endif
main.pm4fg: package/cfg/main_pm4fg.xdl
	@


ifeq (,$(wildcard .libraries,m4fg))
main.pm4fg package/cfg/main_pm4fg.c: .libraries,m4fg
endif

package/cfg/main_pm4fg.c package/cfg/main_pm4fg.h package/cfg/main_pm4fg.xdl: override _PROG_NAME := main.xm4fg
package/cfg/main_pm4fg.c: package/cfg/main_pm4fg.cfg
package/cfg/main_pm4fg.xdc.inc: package/cfg/main_pm4fg.xdl
package/cfg/main_pm4fg.xdl package/cfg/main_pm4fg.c: .interfaces

clean:: clean,m4fg
	-$(RM) package/cfg/main_pm4fg.cfg
	-$(RM) package/cfg/main_pm4fg.dep
	-$(RM) package/cfg/main_pm4fg.c
	-$(RM) package/cfg/main_pm4fg.xdc.inc

clean,m4fg::
	-$(RM) main.pm4fg
.executables,m4fg .executables: main.xm4fg

main.xm4fg: |main.pm4fg

-include package/cfg/main.xm4fg.mak
main.xm4fg: package/cfg/main_pm4fg.om4fg 
	$(RM) $@
	@$(MSG) lnkm4fg $@ ...
	$(RM) $(XDCCFGDIR)$@.map
...
main.test test,m4fg test: main.xm4fg.test

main.xm4fg.test:: main.xm4fg
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 main.xm4fg.test
else
	@$(MSG) running $<  ...
	$(call EXEC.main.xm4fg, ) 
endif

clean,m4fg::
	-$(RM) $(wildcard .tmp,main.xm4fg,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
main_pm4fg.om4fg,copy : package/cfg/main_pm4fg.om4fg
main_pm4fg.sm4fg,copy : package/cfg/main_pm4fg.sm4fg
